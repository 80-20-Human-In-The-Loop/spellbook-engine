...
class TutorialController:
    ...
    def _display_slide_content(self, page_data: dict) -> bool:
        ...
        slide_screen = self.renderer.render_slide_content(
            tutorial_data, page_data, show_question_prompt=page_data["has_question"]
        )
        print(slide_screen)
    ...
    def _handle_question(self, page_data: dict) -> bool:
        ...
        question_content = self.question_renderer.format_complete_question(
            question_data
        )

        # Render question screen with integrated content
        question_screen = self.renderer.render_question_screen(
            tutorial_data, page_data, question_content
        )
        ...
        if result_data:
            result_screen = self.renderer.render_result_screen(
                tutorial_data, page_data, result_data
            )
            print(result_screen)
            ...
            if not can_continue:
                ...
                print(
                    f"{THEME['warning']}You need to master this concept before continuing.{RESET}"
                )
                print(
