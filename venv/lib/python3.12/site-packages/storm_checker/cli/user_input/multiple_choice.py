...
class MultipleChoice:
        ...
        try:
            ...
            while not self.answered:
                ...
                if key == "UP" and self.selected_index > 0:
                    ...
                    key == "DOWN"
                    and self.selected_index < len(self.question.options) - 1
                ):
                    self.selected_index += 1
                    self.display(clear_previous=True)
    ...
    def answer_question(self) -> None:
        ...
        if self.user_answer == self.question.correct_index:
            ...
            print(
                f"{LEARN_YELLOW}The correct answer is: {self.question.options[self.question.correct_index]}{RESET}"
            )
...
def demo():
    ...
    question = Question(
        ...
        options=["list", "List[str]", "list[str]", "str[]"],
        correct_index=2,
