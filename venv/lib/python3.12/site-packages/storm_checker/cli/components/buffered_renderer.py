...
class BufferedRenderer:
    ...
    def _update_terminal_size(self) -> bool:
        ...
        self.terminal_width = self._get_terminal_width()
        self.terminal_height = self._get_terminal_height()
        return old_width != self.terminal_width or old_height != self.terminal_height
    ...
    def render_persistent_message(self, message: str, style: str = "info") -> None:
        """
    ...
    def render_status_line(self, status: str, replace: bool = True) -> None:
        """
...
def create_slideshow_renderer() -> BufferedRenderer:
    ...
    return BufferedRenderer(
        max_buffer_size=100, enable_scroll_regions=True, enable_mouse=False
    )
...
def create_interactive_renderer() -> BufferedRenderer:
    ...
    return BufferedRenderer(
        max_buffer_size=500, enable_scroll_regions=True, enable_mouse=True
    )
...
def demo_buffered_renderer():
    ...
    with BufferedRenderer() as renderer:
        ...
        renderer.render_persistent_message(
            "This message will stay in your terminal history!", "success"
        )
