...
class RichTerminal:
    ...
    def print_markdown(
        self, markdown_content: str, style: str = "default", persist: bool = True
    ) -> None:
    ...
    def print_rule(
        self, title: Optional[str] = None, style: str = "default", persist: bool = True
    ) -> None:
    ...
    def print_tree(
        self, data: Dict[str, Any], title: str = "Tree", persist: bool = True
    ) -> None:
    ...
    def _print_tree_fallback(
        self, data: Dict[str, Any], indent: int = 0, persist: bool = True
    ) -> None:
    ...
    def prompt(
        ...
        if self.use_rich and self.console:
            return Prompt.ask(
                question, default=default, choices=choices, console=self.console
            )
        else:
            # Fallback prompt
...
def demo_rich_terminal():
    ...
    with RichTerminal() as terminal:
        ...
        terminal.print(
            "This is [bold red]formatted text[/bold red] with Rich markup!", markup=True
        )
...
def hello_world():
    ...
    return "success"
        ...
        terminal.print(
            "\n[dim]All output above persists in your terminal history![/dim]",
            markup=True,
        )
