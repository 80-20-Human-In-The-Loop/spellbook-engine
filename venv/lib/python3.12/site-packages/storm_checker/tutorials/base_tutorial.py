...
class BaseTutorial(ABC):
    ...
    def save_progress(self) -> None:
        ...
        try:
            ...
            completion_percentage = (
                self.progress.pages_completed / self.progress.total_pages
            ) * 100
    ...
    def display_page(self, page_number: int) -> bool:
        ...
        print(
            self.slideshow.render_dynamic_content(
                slide,
                ContentMode.SLIDE,
        ...
        if page_number in self.questions:
            ...
            question_nav_hints = (
                f"{THEME['warning']}Knowledge Check in progress...{RESET}"
            )
            ...
            if is_correct:
                ...
                if page_number < len(self.pages) - 1:
                    ...
                    result_content += (
                        "The tutorial will restart. Press Enter to exit..."
                    )
    ...
    def display_completion(self) -> None:
        ...
        message_lines.append(
            f"Your Score: {self.progress.questions_correct}/{self.progress.total_questions} ({score_pct:.0f}%)"
        )
        ...
        if score_pct >= 80:
            ...
            message_lines.append(
                "Keep practicing! You might want to review this tutorial again."
            )
