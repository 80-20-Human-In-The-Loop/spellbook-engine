...
def main() -> None:
    ...
    tutorial_parser = subparsers.add_parser(
        "tutorial", help="MyPy-specific tutorials for learning type safety"
    )
    ...
    genuine_errors, ignored_errors, config_errors, regular_errors = (
        filter_and_categorize_errors(result.errors, runner)
    )
