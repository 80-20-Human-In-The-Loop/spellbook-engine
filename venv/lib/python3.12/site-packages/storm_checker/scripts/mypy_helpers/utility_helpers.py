...
def warn_about_pretty_true(json_mode: bool = False) -> None:
    ...
    if not json_mode:
        print_warning(
            "⚠️  PRETTY=TRUE DETECTED! MUST BE FALSE FOR TOOL TO FUNCTION PROPERLY"
        )
...
def setup_tracking_session(tracker: ProgressTracker, no_track: bool = False) -> None:
    """
...
def process_json_output(result: MypyResult, analysis, ignored_count: int) -> str:
    """
...
def create_analysis_result(
    result: MypyResult, config_errors: List[MypyError]
) -> MypyResult:
    """
