...
try:
    ...
    from storm_checker.logic.progress_tracker import (
        ProgressTracker as EnhancedProgressTracker,
    )
...
def show_achievements(tracker: EnhancedProgressTracker) -> None:
    ...
    for category, achievements in by_category.items():
        ...
        for achievement in achievements:
            ...
            if is_unlocked:
                ...
                print(
                    f"{achievement.icon} {THEME['success']}{achievement.name}{RESET} - {achievement.description}"
                )
                ...
                if progress_info:
                    ...
                    print(
                        f"{THEME['text_muted']}{achievement.icon} {achievement.name} - {achievement.description}{RESET}"
                    )
    ...
    total_points = sum(
        all_achievements[aid].points for aid in data.unlocked if aid in all_achievements
    )
...
Examples:
  ...
  stormcheck progress --tutorials  # Show tutorial progress
    ...
    parser.add_argument(
        "--achievements", action="store_true", help="Show detailed achievements view"
    )
    parser.add_argument(
        "--tutorials", action="store_true", help="Show tutorial-specific progress"
    )
