...
{ColorPrinter.learn('Learn more at: https://github.com/80-20-Human-In-The-Loop/storm-checker')}
    ...
    mypy_parser = subparsers.add_parser(
        "mypy", help="Run MyPy type checker with educational features"
    )

    # Tutorial command
    tutorial_parser = subparsers.add_parser(
        "tutorial", help="Interactive tutorials for learning type safety"
    )

    # Progress command
    progress_parser = subparsers.add_parser(
        "progress", help="Track and display your progress and achievements"
    )
